<template>
  <div class="plans-page">
    ...
    <div class="container">
      <!-- Pricing cards -->
      <p v-if="loading" class="plans-note">Loading plans...</p>
      <p v-else-if="loadError" class="plans-note">{{ loadError }}</p>
...
<script>
import { paymentPlans } from '../data/plans.js'
import { packagesAPI } from '../store/api.js'
