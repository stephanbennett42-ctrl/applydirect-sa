...
app.get('/api/health', (req, res) => {
  res.json({ status: 'ok', module: 'subscription', timestamp: new Date().toISOString() })
})
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`Accessible from other devices on this network via http://<this-machine-ip>:${PORT}`)
