/**
 * Authentication Routes (Subscription module)
 ...
 * Body: { firstName, lastName, email, password, phone, university }
 * New accounts start with status "pending" — an admin must approve them.
 */
